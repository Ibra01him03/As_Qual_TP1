...
public class AnagramTestBrancheCoverage {
    @Test
    ...
    @Test
    public void TwoStringsButSecondNullreturnExecption(){
        Assertions.assertThrows(NullPointerException.class,()-> Anagram.isAnagram("hello",null));
    }
